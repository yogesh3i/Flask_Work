...
# installed.
<<<<<<< HEAD
TCL_PREFIX='D:/Flask/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Flask/venv\Library\bin'
=======
TCL_PREFIX='D:/Flask/Flask_part3/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Flask/Flask_part3/venv\Library\bin'
>>>>>>> f9a46bb (ok)
...
# installed directory.
<<<<<<< HEAD
TCL_LIB_SPEC='D:/Flask/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Flask/venv\Library\include'
=======
TCL_LIB_SPEC='D:/Flask/Flask_part3/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Flask/Flask_part3/venv\Library\include'
>>>>>>> f9a46bb (ok)
...
# installed directory.
<<<<<<< HEAD
TCL_STUB_LIB_SPEC='-LD:/Flask/venv\Library\lib tclstub86.lib'
=======
TCL_STUB_LIB_SPEC='-LD:/Flask/Flask_part3/venv\Library\lib tclstub86.lib'
>>>>>>> f9a46bb (ok)
...
<<<<<<< HEAD
TCL_STUB_LIB_PATH='D:/Flask/venv\Library\lib\tclstub86.lib'
=======
TCL_STUB_LIB_PATH='D:/Flask/Flask_part3/venv\Library\lib\tclstub86.lib'
>>>>>>> f9a46bb (ok)
